...
pub fn insert_build_menu(ui_scene_handles: Res<UiSceneHandles>, mut commands: Commands) {
    ...
    |id: UpdateId, event: BroadcastEvent<MainActionSelected>, mut commands: Commands, mut _scene_builder: ResMut<SceneBuilder>, buildables_query: Query<&Name, With<Buildable>>| {
